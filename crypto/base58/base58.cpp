 ...
 */
secp256k1::uint256 BASE::toBigInt(const std::string &s) {
...
void BASE::toHash160(const std::string &s, unsigned int hash[5]) {
...
bool BASE::isBase58(std::string s) {
    for (unsigned int i = 0; i < s.length(); i++) {
...
std::string BASE::toBase58(const secp256k1::uint256 &x) {
    std::string s;
...
void BASE::getMinMaxFromPrefix(const std::string &prefix, secp256k1::uint256 &minValueOut, secp256k1::uint256 &maxValueOut) {
